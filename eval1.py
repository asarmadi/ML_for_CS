...
parser.add_argument('--model_filename', type=str, default = './models/anonymous_1_bd_net.h5', help='Path to the model')
...
if args.random:
   H_list = np.load('entropy_lists/H_list_rnd_1.npy')
else:
   H_list = np.load('entropy_lists/H_list_1.npy')
